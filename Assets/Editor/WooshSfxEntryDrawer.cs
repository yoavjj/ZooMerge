...
[CustomPropertyDrawer(
    typeof(AudioSfxLibrarySO.WooshSfxEntry)
)]
public class WooshSfxEntryDrawer : PropertyDrawer
{
        ...
        GUIContent label)
    {
        ...
        SfxWoosh selectedCue =
            (SfxWoosh)cueProperty.enumValueIndex;

        selectedCue =
            (SfxWoosh)EditorGUI.EnumPopup(
                row,
                "Woosh Cue",
                selectedCue
            );
