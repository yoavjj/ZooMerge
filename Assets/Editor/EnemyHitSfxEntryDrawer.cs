...
[CustomPropertyDrawer(
    typeof(AudioSfxLibrarySO.EnemyHitSfxEntry)
)]
public class EnemyHitSfxEntryDrawer : PropertyDrawer
{
        ...
        GUIContent label)
    {
        ...
        SfxEnemyHit selectedCue =
            (SfxEnemyHit)cueProperty.enumValueIndex;

        selectedCue = (SfxEnemyHit)EditorGUI.EnumPopup(
            row,
            "Enemy Hit Cue",
            selectedCue
        );
